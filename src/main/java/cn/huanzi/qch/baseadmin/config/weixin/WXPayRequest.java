...
import static cn.huanzi.qch.baseadmin.config.weixin.WXPayConstants.USER_AGENT;
...
public class WXPayRequest {
    ...
    private String request(String urlSuffix, String uuid, String data, int connectTimeoutMs, int readTimeoutMs, boolean useCert, boolean autoReport) throws Exception {
        ...
        long startTimestampMs = cn.huanzi.qch.baseadmin.config.weixin.WXPayUtil.getCurrentTimestampMs();
        ...
        try {
            ...
            elapsedTimeMillis = cn.huanzi.qch.baseadmin.config.weixin.WXPayUtil.getCurrentTimestampMs() - startTimestampMs;
            config.getWXPayDomain().report(domainInfo.domain, elapsedTimeMillis, null);
            cn.huanzi.qch.baseadmin.config.weixin.WXPayReport.getInstance(config).report(
                    uuid,
                    elapsedTimeMillis,
                    domainInfo.domain,
            ...
            firstHasDnsErr = true;
            elapsedTimeMillis = cn.huanzi.qch.baseadmin.config.weixin.WXPayUtil.getCurrentTimestampMs() - startTimestampMs;
            cn.huanzi.qch.baseadmin.config.weixin.WXPayUtil.getLogger().warn("UnknownHostException for domainInfo {}", domainInfo);
            cn.huanzi.qch.baseadmin.config.weixin.WXPayReport.getInstance(config).report(
                    uuid,
                    elapsedTimeMillis,
                    domainInfo.domain,
            ...
            elapsedTimeMillis = cn.huanzi.qch.baseadmin.config.weixin.WXPayUtil.getCurrentTimestampMs() - startTimestampMs;
            cn.huanzi.qch.baseadmin.config.weixin.WXPayUtil.getLogger().warn("connect timeout happened for domainInfo {}", domainInfo);
            cn.huanzi.qch.baseadmin.config.weixin.WXPayReport.getInstance(config).report(
                    uuid,
                    elapsedTimeMillis,
                    domainInfo.domain,
            ...
            elapsedTimeMillis = cn.huanzi.qch.baseadmin.config.weixin.WXPayUtil.getCurrentTimestampMs() - startTimestampMs;
            cn.huanzi.qch.baseadmin.config.weixin.WXPayUtil.getLogger().warn("timeout happened for domainInfo {}", domainInfo);
            cn.huanzi.qch.baseadmin.config.weixin.WXPayReport.getInstance(config).report(
                    uuid,
                    elapsedTimeMillis,
                    domainInfo.domain,
