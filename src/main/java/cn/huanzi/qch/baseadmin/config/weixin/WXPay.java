...
import cn.huanzi.qch.baseadmin.config.weixin.WXPayConstants.SignType;
...
public class WXPay {
    ...
    private cn.huanzi.qch.baseadmin.config.weixin.WXPayConfig config;
    ...
    public WXPay(final cn.huanzi.qch.baseadmin.config.weixin.WXPayConfig config) throws Exception {
        this(config, null, true, false);
    }

    public WXPay(final cn.huanzi.qch.baseadmin.config.weixin.WXPayConfig config, final boolean autoReport) throws Exception {
        this(config, null, autoReport, false);
    }


    public WXPay(final cn.huanzi.qch.baseadmin.config.weixin.WXPayConfig config, final boolean autoReport, final boolean useSandbox) throws Exception{
        this(config, null, autoReport, useSandbox);
    }

    public WXPay(final cn.huanzi.qch.baseadmin.config.weixin.WXPayConfig config, final String notifyUrl) throws Exception {
        this(config, notifyUrl, true, false);
    }

    public WXPay(final cn.huanzi.qch.baseadmin.config.weixin.WXPayConfig config, final String notifyUrl, final boolean autoReport) throws Exception {
        this(config, notifyUrl, autoReport, false);
    }

    public WXPay(final cn.huanzi.qch.baseadmin.config.weixin.WXPayConfig config, final String notifyUrl, final boolean autoReport, final boolean useSandbox) throws Exception {
        this.config = config;
